...
def json_to_csv(path):
    """Iterates through all .json files in a given directory and combines
    ...
    for json_file in glob.glob(path + '/*.json'):
        with open(json_file) as f:
            ...
            for annotation in data['annotations']:
                image_filename = os.path.join(path, data['images'][annotation['image_id']]['file_name'])
                width = data['images'][annotation['image_id']]['width']
                height = data['images'][annotation['image_id']]['height']
